...
![Start Screen](./ChoosePath/docs/start-screen.png)
...
|-------------------|----------------|
| ![Start Screen](./ChoosePath/docs/start-screen.png) | ![Game View](./ChoosePath/docs/game-view.png) |

| Panel de Muerte |
|-----------------|
| ![Death Screen](./ChoosePath/docs/death-screen.png) |
